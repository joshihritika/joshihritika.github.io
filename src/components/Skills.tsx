...
export const Skills = () => {
  const skills = [{
    ...
    items: ['Research Design', 'Quantitative Data Collection', 'Qualitative Interviews', 'Focus Group Discussions (FGDs)', 'Report Writing', 'Document Review', 'Data Analysis', 'Field Research Coordination', 'Budgeting', 'Conducting Orientation Programs', 'Moderation of Capacity Building Programs', 'Remote Digital Collaboration']
  }, {
    ...
    items: ['Microsoft Office Suite', 'Google Workspace', 'Notion', 'Miro', 'Canva', 'Figma', 'Slack', 'Microsoft Teams', 'Zoom', 'KoboToolbox', 'ODK', 'Trello', 'WhatsApp for Work']
  }, {
